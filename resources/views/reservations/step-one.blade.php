                ...
                <div class="flex flex-col md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img class="object-cover w-full h-full"
                            src="https://i.pinimg.com/564x/80/89/51/808951b0b4f53c4e9356849dabcc9235.jpg" alt="img" />
                    </div>
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            <h3 class="mb-4 text-xl font-bold text-#FFFFFF-600">Make Reservation</h3>
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.one') }}">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <span class="text-xs">Please choose the time between 10:00-22:00.</span>
                                    @error('res_date')
                                        <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mt-6 p-4 flex justify-end">
                                    <button type="submit"
                                        class="px-4 py-2 bg-orange-500 hover:bg-orange-700 rounded-lg text-white">Next</button>
                                </div>
                            </form>
                        </div>
                    </div>
