...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-serif text-gray-900 antialiased">
      <div class="bg-black-200 shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
          <div class="flex items-center justify-between">
            <a class="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 md:text-4xl hover:text-yellow-400"
              href="#">
              Crave & Co.
            </a>
            <!-- Mobile menu button
          ...
          <div :class="isOpen ? 'flex' : 'hidden'"
            ...
            <a class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 hover:text-yellow-400"
              href="/">Home</a>
            <a class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-orange-500 hover:text-yellow-400"
      ...
      <footer class="bg-orange-800 border-t border-gray-200">
